...
<html>
    ...
    <script type="text/javascript">
        function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
            $.ajaxFileUpload({
                url: '${pageContext.request.contextPath }/productInfo/ajaxImg.action',//用于文件上传的服务器端请求地址
	...
	<!--取出上一个页面上带来的page的值-->
		...
		<div id="addAll">
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/productInfo/save.action" enctype="multipart/form-data"
...
<%--								<img src="${pageContext.request.contextPath}/image_big/xm6.jpg" width="100px"  height="100px">--%>
							</div><br><br><br><br>
						...
						<tr>
							...
							<td>
								...
								<script type="text/javascript">
									function myclose() {
										window.location="${pageContext.request.contextPath}/productInfo/splitPage.action";
									}
								</script>
							</td>
						</tr>
